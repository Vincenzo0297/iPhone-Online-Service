...
class Vincent_A1.java {
	...
	System.out.print("\nSummary of iPhones");
	System.out.println("\n----------------------\n");
	System.out.printf ("%-5s" + "%-10s   " + "%-10s%n", "iPhone", "Quality", "Price");
	System.out.println ("----------" + "----------" +"----------" +"----------" +"----------" + "-----");
		 
	System.out.printf ("%-5s" + "%5d  " + "%-10.2f%n", "iPhone 12 Mini: ", q1, price1);
	System.out.printf ("%-5s" + "%5d  " + "%-10.2f%n", "iPhone 12 Pro: ", q2, price2);
	System.out.printf ("%-5s" + "%5d  " + "%-10.2f%n", "iPhone 12 Max: ", q3, price3);								
	System.out.println ("----------" + "----------" +"----------" +"----------" +"----------" + "-----");
	...
	System.out.printf ("%-5s" + "%5d  " + "%-10.2f%n","iPhone 12 Pro: ", q1, price1);
	System.out.printf ("%-5s" + "%5d   " + "%-10.2f%n","iPhone 12 Mini: ", q2, price2);
	System.out.printf ("%-5s" + "%5d   " + "%-10.2f%n","iPhone 12 Max: ", q3, price3);							
	System.out.println ("----------" + "----------" +"----------" +"----------" +"----------" + "-----");
	...
	System.out.println("\n----------------------\n");
	System.out.printf ("%-5s" + "%-10s   " + "%-10s%n", "iPhone", "Quality", "Cost");
	System.out.println ("----------" + "----------" +"----------" +"----------" +"----------" + "-----");
		 
	System.out.printf ("%-5s" + "%5d  " + "%-10.2f%n", "iPhone 12 Mini: ", a , totalcost );
	System.out.printf ("%-5s" + "%5d  " + "%-10.2f%n", "iPhone 12 Pro: ", b , totalcost2 );
	System.out.printf ("%-5s" + "%5d  " + "%-10.2f%n", "iPhone 12 Max: ", c , totalcost3 );							
	System.out.println ("----------" + "----------" +"----------" +"----------" +"----------" + "-----");
	    
	//update the subtotal, gst and everything after adding gst 
	subtotal = totalcost + totalcost2 + totalcost3;
	System.out.printf ("%-5s" + "%-5s  " + "%-10.2f%n", "Subtotal: ","\t\t ", subtotal);
	gst = (0.07 * (a*price1));
	gst2 = (0.07 * (b*price2));
	gst3 = (0.07 * (c*price3));
	...
	System.out.printf ("%-5s" + "%-5s  " + "%-10.2f%n", "Gst (7%): ","\t\t ", totalgst);
	everything = totalgst + subtotal;
	System.out.printf ("%-5s" + "%-5s  " + "%-10.2f%n", "Total Cost: ","\t\t ", everything);
	System.out.println ("----------" + "----------" +"----------" +"----------" +"----------" + "-----");
	...
	t2 = q2 - b;
	t3 = q3 - c;
	System.out.printf ("%-5s" + "%-10s   " +"%-10s   "+"%-10s%n", "iPhone", "Quality", "Sold", "Balance");
	System.out.println ("----------" + "----------" +"----------" +"----------" +"----------" + "-----");
	System.out.printf ("%-5s" + "%5d  " +  "%5d  "+ "%5d%n", "iPhone 12 Pro: ", q1, a, t);
	System.out.printf ("%-5s" + "%5d  " +  "%5d  "+ "%5d%n", "iPhone 12 Pro: ", q2, b, t2);
	System.out.printf ("%-5s" + "%5d  " +  "%5d  "+ "%5d%n", "iPhone 12 Pro: ", q3, c, t3);
	System.out.println ("----------" + "----------" +"----------" +"----------" +"----------" + "-----");
	}
}
